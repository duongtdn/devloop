...
- `$TASK` — the task number/title to implement, **or** — when the calling skill has no `plan.md` (`tinker` applying a direct change, `review`'s patch) — the change stated **inline**, naming the exact files you may touch
