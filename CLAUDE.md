...
| Path | Purpose |
|---|---|
| `context/sprints/master-plan.md` | Project sprint map: vision, sprint themes, goals, statuses. Created by `plan` on first use (conversational init). Read and updated by every `plan` and `review` run. |
